...
| Règles de validation EN 16931 | **218** (214 EN 16931 · 2 CIUS FR · 2 Kanjō) |
| Parité vs Schematron officiel CEN | **213 / 223** (95 %) — [détail](CONFORMITE-EN16931.md) |
...
complet des **218 règles** est publié et généré depuis le code dans [`rules.md`](rules.md) ; il
...
réelle — actuellement **213/223 (95 %)** — avec un **cliquet anti-régression** et régénère le
