...
| Règles de validation EN 16931 | **165** (161 EN 16931 · 2 CIUS FR · 2 Kanjō) |
| Parité vs Schematron officiel CEN | **160 / 223** (71 %) — [détail](CONFORMITE-EN16931.md) |
...
complet des **165 règles** est publié et généré depuis le code dans [`rules.md`](rules.md) ; il
...
réelle — actuellement **160/223 (71 %)** — avec un **cliquet anti-régression** et régénère le
