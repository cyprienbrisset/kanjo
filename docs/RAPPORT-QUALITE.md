...
| Règles de validation EN 16931 | **158** (154 EN 16931 · 2 CIUS FR · 2 Kanjō) |
| Parité vs Schematron officiel CEN | **153 / 223** (68 %) — [détail](CONFORMITE-EN16931.md) |
...
complet des **158 règles** est publié et généré depuis le code dans [`rules.md`](rules.md) ; il
...
réelle — actuellement **153/223 (68 %)** — avec un **cliquet anti-régression** et régénère le
