...
| Règles de validation EN 16931 | **98** (94 EN 16931 · 2 CIUS FR · 2 Kanjō) |
| Parité vs Schematron officiel CEN | **93 / 223** (42 %) — [détail](CONFORMITE-EN16931.md) |
...
complet des **98 règles** est publié et généré depuis le code dans [`rules.md`](rules.md) ; il
...
réelle — actuellement **93/223 (42 %)** — avec un **cliquet anti-régression** et régénère le
