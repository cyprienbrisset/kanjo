...
| Règles de validation EN 16931 | **122** (118 EN 16931 · 2 CIUS FR · 2 Kanjō) |
| Parité vs Schematron officiel CEN | **117 / 223** (52 %) — [détail](CONFORMITE-EN16931.md) |
...
complet des **122 règles** est publié et généré depuis le code dans [`rules.md`](rules.md) ; il
...
réelle — actuellement **117/223 (52 %)** — avec un **cliquet anti-régression** et régénère le
