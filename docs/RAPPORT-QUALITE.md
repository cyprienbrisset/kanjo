...
| Règles de validation EN 16931 | **137** (133 EN 16931 · 2 CIUS FR · 2 Kanjō) |
...
complet des **137 règles** est publié et généré depuis le code dans [`rules.md`](rules.md) ; il
...
réelle — actuellement **132/223 (59 %)** — avec un **cliquet anti-régression** et régénère le
