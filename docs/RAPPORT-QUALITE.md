...
| Règles de validation EN 16931 | **215** (211 EN 16931 · 2 CIUS FR · 2 Kanjō) |
| Parité vs Schematron officiel CEN | **210 / 223** (94 %) — [détail](CONFORMITE-EN16931.md) |
...
complet des **215 règles** est publié et généré depuis le code dans [`rules.md`](rules.md) ; il
...
réelle — actuellement **210/223 (94 %)** — avec un **cliquet anti-régression** et régénère le
