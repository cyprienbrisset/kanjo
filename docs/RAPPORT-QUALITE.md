...
| Règles de validation EN 16931 | **185** (181 EN 16931 · 2 CIUS FR · 2 Kanjō) |
| Parité vs Schematron officiel CEN | **180 / 223** (80 %) — [détail](CONFORMITE-EN16931.md) |
...
complet des **185 règles** est publié et généré depuis le code dans [`rules.md`](rules.md) ; il
...
réelle — actuellement **180/223 (80 %)** — avec un **cliquet anti-régression** et régénère le
