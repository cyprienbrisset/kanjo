...
### Parité mesurée : **223 / 223 règles EN 16931 (100 %)** ✅
...
| Listes de codes (`BR-CL`) | **23 / 23** | | Autoliquidation (`BR-AE`) | **10 / 10** |
...
Suivie par [`test/parity_test.go`](test/parity_test.go) ; détail par famille dans [`docs/CONFORMITE-EN16931.md`](docs/CONFORMITE-EN16931.md) (généré). **Couverture intégrale du Schematron officiel CEN**, sans aucun stub : chaque règle est réellement calculée et éprouvée sur le corpus.
