...
[![EN 16931](https://img.shields.io/badge/EN%2016931-57%20règles-24405E)](#conformité)
...
- **57 règles** réparties en trois jeux (`en16931`, `cius.fr`, `kanjo`), chacune avec un test passant et un test échouant ; catalogue généré dans [`docs/rules.md`](docs/rules.md).
